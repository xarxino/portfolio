    ...
    <div class="container max-w-7xl pt-12 pb-6 md:pt-16 md:pb-12 lg:pt-24 lg:pb-12 xl:pt-32 xl:pb-12 w-[90%] lg:w-[80%] 2xl:w-[70%] mx-auto flex flex-col gap-12 md:gap-16 lg:gap-24 xl:gap-32 justify-between">
        ...
        <div class="flex flex-col gap-6 md:gap-12 lg:gap-16 xl:gap-24">
            <div class="flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-16">
                <a target="_blank" href="https://dribbble.com/varvino" class="font-display font text-2xl lg:text-3xl xl:text-4xl border-b-2 border-transparent transition-all pb-2 hover:border-white">Dribbble</a>
                <a target="_blank" href="https://www.linkedin.com/in/tomgraafmans/" class="font-display font text-2xl lg:text-3xl xl:text-4xl border-b-2 border-transparent transition-all pb-2 hover:border-white">LinkedIn</a>
            </div>
